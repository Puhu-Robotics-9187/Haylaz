...
public class DriveSubsystem extends SubsystemBase {
  ...
  public DifferentialDrive haylazDrive;
  ...
  public DriveSubsystem(){
    ...
    lGroup.setInverted(false);
    rGroup.setInverted(true);
...
public void curvatureDrive(double x , double z){
  haylazDrive.curvatureDrive(x, z, false);
}
